        ...
        if (ihi >= ilo + 2) {
            for (jcol = ilo - 1; jcol + 1 < ihi - 1; jcol++) {
                ...
                for (int jrow = ihi - 1; jrow + 1 > jcol + 2; jrow--) {
                    At_tmp = jrow + 6 * jcol;
                    internal::reflapack::xzlartg(At[At_tmp - 1], At[At_tmp],
                                                 &absxk, &atmp,
                                                 &At[(jrow + 6 * jcol) - 1]);
                    At[At_tmp].re = 0.0;
                    At[At_tmp].im = 0.0;
                    for (j = jcolp1; j < 7; j++) {
                        ...
                        ctoc = absxk * At[nzcount - 1].re +
                               (atmp.re * At[nzcount].re -
                                atmp.im * At[nzcount].im);
                        stemp_im = absxk * At[nzcount - 1].im +
                                   (atmp.re * At[nzcount].im +
                                    atmp.im * At[nzcount].re);
                        cto1 = At[nzcount - 1].re;
                        At[nzcount].re = absxk * At[nzcount].re -
                                         (atmp.re * At[nzcount - 1].re +
                    ...
                    for (i = 1; i <= ihi; i++) {
                        ...
                        ii = (i + 6 * jrow) - 1;
                        ctoc = absxk * At[ii].re + (atmp.re * At[nzcount].re -
                                                    atmp.im * At[nzcount].im);
                        stemp_im =
                            absxk * At[ii].im + (atmp.re * At[nzcount].im +
                                                 atmp.im * At[nzcount].re);
                        cto1 = At[ii].re;
                        At[nzcount].re =
                            absxk * At[nzcount].re -
